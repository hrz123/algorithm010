...
# 已经自动初始化
# f(start, 1) = start  只有一个鸡蛋时只能一层一层试
# start = 0的时候一直为0
# 只需要从i等于1遍历到i=n
# 返回值 f(n, m)
# 优化空间复杂度
