...
class Solution:
    def isPalindrome(self, x: int) -> bool:
        ...
        while x > revertedNumber:
            ...
            x //= 10
        # When the length is an odd number, we can build rid of the middle digit by revertedNumber/10
        # For example when the s is 12321, at the end of the while loop we build x = 12, revertedNumber = 123,
